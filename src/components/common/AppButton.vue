...
export default defineComponent({
  ...
  render() {
    ...
    return h(
      ...
      {
        ...this.$attrs,
        // `class` hem string hem object olabildiği için Vue'nun sınıf birleştirme kurallarına uygun şekilde array veriyoruz.
        class: [this.buttonClasses, this.$attrs?.class],
      },
      slot ?? []
    )
  }
